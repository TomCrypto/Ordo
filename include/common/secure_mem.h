...
/*! Allocates a pointer which is locked in physical memory.
 ...
 @return Returns the allocated pointer on success, or 0 if the function fails.
         ...
         operation.
 @remarks Sometimes, operating systems can decide to page out rarely-accessed
          ...
          system not to page out the allocated memory. Note that this is a hint
          to the operating system, nothing more. Consult your system's
          implementation of virtual memory locking to know more.
...
/*! Marks memory as read-only.
 ...
 @return Returns \c 0 on success, and anything else on failure.
 @remarks If this function succeeds, any attempt to write to the memory will
...
/*! Frees a pointer, and securely erases the memory it points to.
 ...
 @param size The amount of memory, in bytes, pointed to by \c ptr.
