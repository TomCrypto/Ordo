...
enum BLOCK_CIPHER
{
    BLOCK_NULLCIPHER                                                 = 0xFF20,
    BLOCK_THREEFISH256                                               = 0x1A20,
    BLOCK_AES                                                        = 0x0C20,
};

enum BLOCK_MODE
{
    BLOCK_MODE_ECB                                                   = 0x8040,
    BLOCK_MODE_CBC                                                   = 0x8140,
    BLOCK_MODE_CTR                                                   = 0x8240,
    BLOCK_MODE_CFB                                                   = 0x8340,
    BLOCK_MODE_OFB                                                   = 0x8440,
};
