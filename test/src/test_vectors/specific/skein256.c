/*===-- test/test_vectors/specific/skein256.c ----------*- PUBLIC -*- C -*-===*/
/**
*** @file
*** @brief Test Vectors
***
*** This unit tests specific features of the Skein-256 hash function.
**/
/*===----------------------------------------------------------------------===*/
...
static int check(struct TEST_VECTOR test)
{
    ...
    ASSERT_SUCCESS(hash_init(&state, HASH_SKEIN256, &params));
...
int test_vectors_skein256_1(void);
int test_vectors_skein256_1(void)
{
    size_t t;
