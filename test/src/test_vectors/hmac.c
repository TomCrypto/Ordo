/*===-- test/test_vectors/hmac.c -----------------------*- PUBLIC -*- C -*-===*/
/**
*** @file
*** @brief Test Vectors
***
*** This unit provides test vectors for the HMAC module.
**/
/*===----------------------------------------------------------------------===*/
...
static int check(struct TEST_VECTOR test)
{
    ...
    ASSERT_SUCCESS(hmac_init(&ctx, test.key, test.key_len,
                             test.primitive, 0));

    hmac_update(&ctx, test.input, test.input_len);
