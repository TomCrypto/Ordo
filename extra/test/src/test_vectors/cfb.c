/*===-- test/test_vectors/cfb.c ------------------------*- PUBLIC -*- C -*-===*/
/**
*** @file
*** @brief Test Vectors
***
*** Test vectors for the CFB block mode.
**/
/*===----------------------------------------------------------------------===*/
...
{
{
    ...
    "\xe1\xe1\xe1\xe1\xe1\xe1\xe1\xe1\xe1\xe1\xe1\xe1\xe1\xe1\xe1\xe1", 48,
    BLOCK_NULLCIPHER
}
};
