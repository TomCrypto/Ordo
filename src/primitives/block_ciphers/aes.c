...
/* This is the times 2 lookup table combined with the substitution box. */
...
/* This is the times 3 lookup table combined with the substitution box. */
...
/* This is the times 2 lookup table. */
...
/* This is the times 9 lookup table. */
...
/* This is the times B lookup table. */
...
/* This is the times D lookup table. */
...
/* This is the times E lookup table. */
...
static const uint8_t ks[11] = {0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36};

/* Expands a variable-size key to a certain number of rounds. */
static void ExpandKey(const uint8_t *key, uint8_t *ext, size_t key_len, size_t rounds)
{
    /* Local variables. */
    uint8_t tmp[5];
    size_t t;
...
{
    if (state->key_len) mem_free(state->key);
    mem_free(state);
}
