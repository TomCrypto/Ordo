...
Current work is focused towards finishing the cipher interface. Important todo's:
 ...
 - improve error handling (this is important)
...
The code on Github should normally be functional (unless we screwed a commit up), but of course it has only been tested under a limited number of platforms, so you may have to patch up the code to make it work under your compiler/OS. Tested platforms so far:

- Windows Seven [32-bit] GCC
- Ubuntu 12.04 [64-bit] GCC
