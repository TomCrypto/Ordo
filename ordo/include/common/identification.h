 ...
 * in arrays to facilitate the implementation of functions such as \c block_cipher_by_name(), and are initialized via
 ...
 * \c block_cipher_by_id() which will return the correct block cipher object.
 *
