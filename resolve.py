...
""" The list of primitives, should be kept updated when new ones are added! """
primitives = [
...
def extract_state_struct(fd):
    """ Extracts a primitive state structure from a file, fails if none is found. """
    source = fd.readlines()
